    ...
    <div id="wrapper" class="">
        ...
        <section id="content">
            <div class="container content">
                ...
                <h3 style="text-transform: uppercase;color: #333; font-size:27px;"><strong><?php echo ($row[2]);
                                                                                            echo str_repeat("&nbsp;", 1);
                                                                                            echo ($row[3]); ?></strong></h3>

                <h6 style="color: #ef801a; margin-top: 10px; margin-bottom: 5px; font-size:20px;">
                    <p><strong>ID : </strong><span style="color: #333;"><?php echo ($row[0]); ?></span></p>
                </h6>

                <h6 style="color: #ef801a; margin-top: 5px; margin-bottom: 5px; font-size:20px;">
                    <p><strong>EMAIL : </strong><span style="color: #333;"><?php echo ($row[1]); ?></span></p>
                </h6>

                <h6 style="color: #ef801a; margin-top: 5px; margin-bottom: 5px; font-size:20px;">
                    <p><strong>PHONE NUMBER : </strong><span style="color: #333;"><?php echo ($row[8]); ?></span></p>
                </h6>

                <h6 style="color: #ef801a; margin-top: 5px; margin-bottom: 5px; font-size:20px;">
                    <p><strong>DEPARTMENT : </strong><span style="color: #333;"><?php echo ($row[9]); ?></span></p>
                </h6>

                <h6 style="color: #ef801a; margin-top: 5px; margin-bottom: 5px; font-size:20px;">
                    <p><strong>START DATE : </strong><span style="color: #333;"><?php echo date('jS F, Y', strtotime($row[7])); ?></span></p>
                </h6>

                <h6 style="color: #ef801a; margin-top: 5px; margin-bottom: 5px; font-size:20px;">
                    <p><strong>BALANCE : </strong><span style="color: #333;"><?php echo ($row[6]);  ?> TK</span></p>
                </h6>

                <h6 style="color: #ef801a; margin-top: 5px; margin-bottom: 5px; font-size:20px;">
                    <p><strong>TUTOOR RATING : </strong><span style="color: #333;"><?php echo ($row[13]); ?></span></p>
                </h6>
                ...
                <h6 style="color: #ef801a; margin-top: 5px; margin-bottom: 5px; font-size:20px;">
                    <p><strong>TAKEN TUITION COUNT : </strong><span style="color: #333;"><?php echo ($rowcount[0]); ?></span></p>
                </h6>
                ...
                <h6 style="color: #ef801a; margin-top: 5px; margin-bottom: 5px; font-size:20px;">
                    <p><strong>GIVEN TUITION COUNT : </strong><span style="color: #333;"><?php echo ($rowcount1[0]); ?></span></p>
                </h6>
                            ...
                            <div class="row">
                                <div style="background-color: #ffffff;
                                  ...
                                  padding: 45px;">
                                    ...
                                    <h6 style="margin-top: 0px; margin-bottom: 5px; font-size:12px; text-align: right">
                                        <p>Posted on <?php echo date('jS F, Y', strtotime($rowpost[0]));  ?></p>
                                    </h6>
                                    ...
                                    <h6 style="color: #ef801a; margin-top: 25px; margin-bottom: 0px; font-size:13px;">
                                        <p><strong>Topic Description : </strong><span style="color: #333;"><?php echo ($rowpost[8]); ?></span></p>
                                    </h6>
                                    ...
                                    ?>
                                        ...
                                        <h4 style="color: #333; margin-bottom: 1px;font-size:15px; text-align: right"><strong><?php echo ($row2[2]);
                                                                                                                                echo str_repeat("&nbsp;", 1);
                                                                                                                                echo ($row2[3]);
                                                                                                                                echo str_repeat("&nbsp;", 15); ?></strong><strong>
                            ...
                            <div class="row">
                                <div style="background-color: #ffffff;
                                  ...
                                  padding: 45px;">
                                    ...
                                    <h6 style="margin-top: 0px; margin-bottom: 5px; font-size:12px; text-align: right">
                                        <p>Posted on <?php echo date('jS F, Y', strtotime($rowpost1[0]));  ?></p>
                                    </h6>
                                    ...
                                    <h6 style="color: #ef801a; margin-top: 25px; margin-bottom: 0px; font-size:13px;">
                                        <p><strong>Topic Description : </strong><span style="color: #333;"><?php echo ($rowpost1[8]); ?></span></p>
                                    </h6>
                                    ...
                                    <h4 style="color: #333; margin-bottom: 1px;font-size:15px; text-align: right"><strong><?php echo ($row22[2]);
                                                                                                                            echo str_repeat("&nbsp;", 1);
                                                                                                                            echo ($row22[3]);
                                                                                                                            echo str_repeat("&nbsp;", 15); ?></strong><strong style="font-size:16px; color: #4CAF50;">
                            ...
                            <div class="row">
                                <div style="background-color: #ffffff;
                                  ...
                                  padding: 45px;">
                                    ...
                                    <h6 style="margin-top: 0px; margin-bottom: 5px; font-size:12px; text-align: center">
                                        <p>Posted on <?php echo date('jS F, Y', strtotime($rowpost2[0]));  ?></p>
                                    </h6>
                                    ...
                                    <h6 style="color: #ef801a; margin-top: 25px; margin-bottom: 0px; font-size:13px;">
                                        <p><strong>Topic Description : </strong><span style="color: #333;"><?php echo ($rowpost2[8]); ?></span></p>
                                    </h6>
                                  ...
                                  width: 50px;
                                  height: 50px;
                                  border-radius: 50%; margin-top: 7px;" src="data:image;base64,' . $row23[4] . '"/></a>';
                                                                                                                            echo str_repeat("&nbsp;", 7); ?><?php echo ($row23[2]);
                                                                                                                                                        echo str_repeat("&nbsp;", 1);
                                                                                                                                                        echo ($row23[3]);
                                                                                                                                                        echo str_repeat("&nbsp;", 15); ?></strong><strong style="font-size:16px; color: #4CAF50;">
