                                ...
                                <div style="background-color: #ffffff;
                                  ...
                                  padding: 45px;">
                                    ...
                                    <h6 style="margin-top: 0px; margin-bottom: 5px; font-size:12px; text-align: right">
                                        <p>Posted on <?php echo date('jS F, Y', strtotime($row[0]));  ?></p>
                                    </h6>
                                    ...
                                    <h6 style="color: #ef801a; margin-top: 25px; margin-bottom: 0px; font-size:13px;">
                                        <p><strong>Topic Description : </strong><span style="color: #333;"><?php echo ($row[8]); ?></span></p>
                                    </h6>
                                    ...
                                    <h6 style="margin-top: 15px; margin-bottom: 3px; font-size:12px;">
                                        <p>Other Requirements - Interested tutors are requested to apply.</p>
                                    </h6>
                                ...
                                <form action="findtuition.php" method="post">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="exampleFormControlSelect1" name="co">
                                            ...
                                            ?>
                                                <option value="<?php echo "$row_s1[0]"; ?>"><?php echo "$row_s1[0]";
                                                                                            echo str_repeat("&nbsp;", 7);
                                                                                            echo "$row_s1[1]"; ?></option>
                        ...
                        ?>
                            ...
                            <div class="row">
                                ...
                                WHERE Course_ID = '$row[9]'";
                                    ...
                                    <h6 style="color: #ef801a; margin-top: 25px; margin-bottom: 0px; font-size:13px;">
                                        <p><strong>Course ID: </strong><span style="color: #333;"><?php echo "$row_course[0]";
                                                                                                    echo str_repeat("&nbsp;", 7);
                                                                                                    echo "$row_course[1]"; ?></span></p>
                                    </h6>
