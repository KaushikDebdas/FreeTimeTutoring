    ...
    <div id="wrapper" class="">
        ...
        <section id="content">
            <div class="container content">
                ...
                <h3 style="text-transform: uppercase;color: #333; font-size:27px;"><strong><?php echo ($rowt[2]);
                                                                                            echo str_repeat("&nbsp;", 1);
                                                                                            echo ($rowt[3]); ?></strong></h3>

                <h6 style="color: #ef801a; margin-top: 10px; margin-bottom: 5px; font-size:20px;">
                    <p><strong>ID : </strong><span style="color: #333;"><?php echo ($rowt[0]); ?></span></p>
                </h6>

                <h6 style="color: #ef801a; margin-top: 5px; margin-bottom: 5px; font-size:20px;">
                    <p><strong>EMAIL : </strong><span style="color: #333;"><?php echo ($rowt[1]); ?></span></p>
                </h6>

                <h6 style="color: #ef801a; margin-top: 5px; margin-bottom: 5px; font-size:20px;">
                    <p><strong>PHONE NUMBER : </strong><span style="color: #333;"><?php echo ($rowt[8]); ?></span></p>
                </h6>

                <h6 style="color: #ef801a; margin-top: 5px; margin-bottom: 5px; font-size:20px;">
                    <p><strong>DEPARTMENT : </strong><span style="color: #333;"><?php echo ($rowt[9]); ?></span></p>
                </h6>

                <h6 style="color: #ef801a; margin-top: 5px; margin-bottom: 5px; font-size:20px;">
                    <p><strong>START DATE : </strong><span style="color: #333;"><?php echo date('jS F, Y', strtotime($rowt[7])); ?></span></p>
                </h6>

                <h6 style="color: #ef801a; margin-top: 5px; margin-bottom: 5px; font-size:20px;">
                    <p><strong>TUTOOR RATING : </strong><span style="color: #333;"><?php echo ($rowt[13]); ?></span></p>
                </h6>
